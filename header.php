      ...
      <div class="header-wrapper">
        <header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
          <div class="action-bar np">
            ...
            <strong>Can we get to 75,000? &mdash;</strong> Over 70,000 Voter Registrations / Updates since Feb 1st! </strong> <a href="http://voteforbernie.org/register-to-vote/" data-track="RegToVote,CTA">Get Registered Now</a>
