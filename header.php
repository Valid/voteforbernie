      ...
      <div class="header-wrapper">
        <header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
          <div class="action-bar np">
            ...
            <strong>$940,000 raised so far &mdash;</strong> Let's get it to $1,000,000 before Iowa! <a href="http://berniesanders.com/reddit" data-track="CTA,1mdonate">Donate to Bernie!</a>
